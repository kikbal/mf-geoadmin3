(function() {
   ...
   *
   * The manager works with a "layers" array. It watches the array array (using
   * $watchCollection) and updates the "layers" parameter in the permalink when
   * the array changes. It also watches "opacity" and "visibility" on each
   * layer and updates the "layers_opacity" and "layers_visibility" parameters
   * as appropriate.
   *
   * And, at application init time, it adds to the map the layers specified in
   * the permalink, and the opacity and visibility of layers.
   */
